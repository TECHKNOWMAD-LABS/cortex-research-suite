...
_DOMAIN_TERMS: dict[str, dict[str, list[str]]] = {
    "healthcare": {
        "topic": [
            "CRISPR gene editing", "mRNA therapeutics", "AI-assisted radiology",
            "telemedicine platforms", "personalized medicine", "immunotherapy",
            "wearable biomarkers", "digital pathology", "robotic surgery",
        ],
        "condition": [
            "chronic kidney disease", "Type 2 diabetes", "non-small cell lung cancer",
            "Alzheimer's disease", "cardiovascular disease", "autoimmune disorders",
            "rare genetic conditions", "treatment-resistant depression",
        ],
    },
    "finance": {
        "topic": [
            "algorithmic trading strategies", "decentralized lending protocols",
            "central bank digital currencies", "credit risk modeling",
            "ESG-integrated portfolios", "options volatility surfaces",
            "stablecoin mechanisms", "tokenized real-world assets",
        ],
        "market_condition": [
            "rising interest rates", "a liquidity crisis", "post-pandemic recovery",
            "high inflation environment", "emerging market volatility",
            "regulatory tightening", "technology sector correction",
        ],
    },
    "technology": {
        "topic": [
            "microservices architecture", "WebAssembly runtimes", "vector databases",
            "confidential computing", "edge ML inference", "service mesh",
            "event-driven architecture", "zero-trust networking",
        ],
        "use_case": [
            "real-time fraud detection", "autonomous vehicle coordination",
            "large-scale recommendation systems", "IoT fleet management",
            "multi-tenant SaaS platforms", "high-frequency trading systems",
            "healthcare data interoperability",
        ],
    },
    "policy": {
        "policy": [
            "AI regulation framework", "carbon pricing mechanisms",
            "universal basic income", "data localization requirements",
            "open banking mandates", "gig economy worker protections",
            "antitrust reform for tech platforms",
        ],
        "sector": [
            "technology industry", "healthcare delivery", "financial services",
            "education systems", "transportation infrastructure",
            "energy markets", "housing and real estate",
        ],
    },
}
