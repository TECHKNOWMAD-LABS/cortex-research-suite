...
_FIELDS = [
    "artificial intelligence", "computational biology", "materials science",
    "behavioral economics", "systems engineering", "public health",
    "climate science", "cognitive neuroscience", "cybersecurity",
    "distributed systems", "epidemiology", "financial engineering",
    "genomics", "human-computer interaction", "information theory",
    "network science", "operations research", "quantum information",
    "robotics", "sustainable energy",
]

_TOPICS = [
    "model interpretability", "drug discovery pipelines", "carbon capture mechanisms",
    "decision-making under uncertainty", "fault-tolerant architectures",
    "pandemic preparedness", "neural architecture search", "market microstructure",
    "gene therapy delivery", "adversarial robustness", "supply chain resilience",
    "federated learning", "protein structure prediction", "renewable grid integration",
    "autonomous navigation", "privacy-preserving computation",
    "reinforcement learning from human feedback", "climate tipping points",
    "social network dynamics", "ethical AI governance",
]
