...
- **skill-test-harness**: Test framework for skills with coverage reporting and 8 assertion types
...
# Skills load automatically via SKILL.md
```
...
├── cortex/                     # Python framework (evaluation, agents, synthetic data)
├── cross-platform/
...
```json
{
  ...
  "platforms": {
    ...
    "mcp_server": { "command": "uv", "args": ["run", "python", "server.py"] },
