...
**Title:** Cortex Research Suite -- 27 self-evolving research skills, open source, works with Claude Code + MCP adapters
...
1. **Foundation** -- 27 core skills + evaluation lab with deterministic scoring
